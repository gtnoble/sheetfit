...
package gsl_gsl_block_complex_float_h is
  ...
  --  
   ...
   type gsl_block_complex_float_struct is record
      size : aliased stddef_h.size_t;  -- /usr/include/gsl/gsl_block_complex_float.h:40
   ...
   function gsl_block_complex_float_alloc (n : stddef_h.size_t) return access gsl_block_complex_float  -- /usr/include/gsl/gsl_block_complex_float.h:46
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_complex_float_alloc";

   function gsl_block_complex_float_calloc (n : stddef_h.size_t) return access gsl_block_complex_float  -- /usr/include/gsl/gsl_block_complex_float.h:47
   with Import => True, 
        Convention => C, 
   ...
   function gsl_block_complex_float_size (b : access constant gsl_block_complex_float) return stddef_h.size_t  -- /usr/include/gsl/gsl_block_complex_float.h:60
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_complex_float_size";

   function gsl_block_complex_float_data (b : access constant gsl_block_complex_float) return access float  -- /usr/include/gsl/gsl_block_complex_float.h:61
   with Import => True, 
        Convention => C, 
