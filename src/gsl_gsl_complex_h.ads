...
package gsl_gsl_complex_h is
   ...
   type gsl_complex_packed is
     access all double;  -- /usr/include/gsl/gsl_complex.h:38

   type gsl_complex_packed_float is
     access all Float;  -- /usr/include/gsl/gsl_complex.h:39

   type gsl_complex_packed_long_double is
     access all long_double;  -- /usr/include/gsl/gsl_complex.h:40

   type gsl_const_complex_packed is
     access all double;  -- /usr/include/gsl/gsl_complex.h:42

   type gsl_const_complex_packed_float is
     access all Float;  -- /usr/include/gsl/gsl_complex.h:43

   type gsl_const_complex_packed_long_double is
     access all long_double;  -- /usr/include/gsl/gsl_complex.h:44

   -- 2N consecutive built-in types as N complex numbers
   type gsl_complex_packed_array is
     access all double;  -- /usr/include/gsl/gsl_complex.h:48

   type gsl_complex_packed_array_float is
     access all Float;  -- /usr/include/gsl/gsl_complex.h:49

   type gsl_complex_packed_array_long_double is
     access all long_double;  -- /usr/include/gsl/gsl_complex.h:50

   type gsl_const_complex_packed_array is
     access all double;  -- /usr/include/gsl/gsl_complex.h:52

   type gsl_const_complex_packed_array_float is
     access all Float;  -- /usr/include/gsl/gsl_complex.h:53

   type gsl_const_complex_packed_array_long_double is
     access all long_double;  -- /usr/include/gsl/gsl_complex.h:54
   ...
   type gsl_complex_packed_ptr is
     access all double;  -- /usr/include/gsl/gsl_complex.h:62

   type gsl_complex_packed_float_ptr is
     access all Float;  -- /usr/include/gsl/gsl_complex.h:63

   type gsl_complex_packed_long_double_ptr is
     access all long_double;  -- /usr/include/gsl/gsl_complex.h:64

   type gsl_const_complex_packed_ptr is
     access all double;  -- /usr/include/gsl/gsl_complex.h:66

   type gsl_const_complex_packed_float_ptr is
     access all Float;  -- /usr/include/gsl/gsl_complex.h:67

   type gsl_const_complex_packed_long_double_ptr is
     access all long_double;  -- /usr/include/gsl/gsl_complex.h:68
   ...
   type gsl_complex is record
     ...
     Convention => C_Pass_By_Copy;  -- /usr/include/gsl/gsl_complex.h:136
   ...
   type gsl_complex_long_double is record
     ...
     Convention => C_Pass_By_Copy;  -- /usr/include/gsl/gsl_complex.h:137
   ...
   type gsl_complex_float is record
     ...
     Convention => C_Pass_By_Copy;  -- /usr/include/gsl/gsl_complex.h:138
