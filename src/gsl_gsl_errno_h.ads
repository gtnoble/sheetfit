...
package gsl_gsl_errno_h is
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_error";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_stream_printf";

   function gsl_strerror
     (gsl_errno : int) return Interfaces.C.Strings
     .chars_ptr  -- /usr/include/gsl/gsl_errno.h:83
   with
     Import => True, Convention => C, External_Name => "gsl_strerror";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_set_error_handler";
   ...
   function gsl_set_stream_handler
     (new_handler : access procedure
        (arg1 : Interfaces.C.Strings.chars_ptr;
