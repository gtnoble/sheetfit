...
package gsl_gsl_matrix_double_h is
   ...
   type gsl_matrix is record
      size1 : aliased stddef_h
        .size_t;  -- /usr/include/gsl/gsl_matrix_double.h:45
      size2 : aliased stddef_h
        .size_t;  -- /usr/include/gsl/gsl_matrix_double.h:46
      tda   : aliased stddef_h
        .size_t;  -- /usr/include/gsl/gsl_matrix_double.h:47
      data  : access double;  -- /usr/include/gsl/gsl_matrix_double.h:48
      block : access gsl_gsl_block_double_h
        .gsl_block_struct;  -- /usr/include/gsl/gsl_matrix_double.h:49
   ...
   -- Allocation
   function gsl_matrix_alloc
     (n1 : stddef_h.size_t;
      n2 : stddef_h.size_t)
      return access gsl_matrix  -- /usr/include/gsl/gsl_matrix_double.h:70
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_alloc";

   function gsl_matrix_calloc
     (n1 : stddef_h.size_t;
      n2 : stddef_h.size_t)
      return access gsl_matrix  -- /usr/include/gsl/gsl_matrix_double.h:73
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_calloc";
   ...
   function gsl_matrix_alloc_from_matrix
     (m  : access gsl_matrix; k1 : stddef_h.size_t; k2 : stddef_h.size_t;
      n1 : stddef_h.size_t;
      n2 : stddef_h.size_t)
   ...
   function gsl_vector_alloc_row_from_matrix
     (m : access gsl_matrix; i : stddef_h.size_t)
   ...
   function gsl_vector_alloc_col_from_matrix
     (m : access gsl_matrix; j : stddef_h.size_t)
      return access gsl_gsl_vector_double_h
   ...
   procedure gsl_matrix_free
     (m : access gsl_matrix)  -- /usr/include/gsl/gsl_matrix_double.h:97
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_free";

   -- Views
   function gsl_matrix_submatrix
     (m  : access gsl_matrix; i : stddef_h.size_t; j : stddef_h.size_t;
      n1 : stddef_h.size_t;
      n2 : stddef_h.size_t)
      return u_gsl_matrix_view  -- /usr/include/gsl/gsl_matrix_double.h:102
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_submatrix";

   function gsl_matrix_row
     (m : access gsl_matrix; i : stddef_h.size_t)
      return gsl_gsl_vector_double_h
     .u_gsl_vector_view  -- /usr/include/gsl/gsl_matrix_double.h:107
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_row";

   function gsl_matrix_column
     (m : access gsl_matrix; j : stddef_h.size_t)
      return gsl_gsl_vector_double_h
     .u_gsl_vector_view  -- /usr/include/gsl/gsl_matrix_double.h:110
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_column";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_diagonal";

   function gsl_matrix_subdiagonal
     (m : access gsl_matrix; k : stddef_h.size_t)
      return gsl_gsl_vector_double_h
   ...
   function gsl_matrix_superdiagonal
     (m : access gsl_matrix; k : stddef_h.size_t)
      return gsl_gsl_vector_double_h
   ...
   function gsl_matrix_subrow
     (m : access gsl_matrix; i : stddef_h.size_t; offset : stddef_h.size_t;
      n : stddef_h.size_t)
      return gsl_gsl_vector_double_h
     .u_gsl_vector_view  -- /usr/include/gsl/gsl_matrix_double.h:122
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_subrow";

   function gsl_matrix_subcolumn
     (m : access gsl_matrix; j : stddef_h.size_t; offset : stddef_h.size_t;
      n : stddef_h.size_t)
      return gsl_gsl_vector_double_h
     .u_gsl_vector_view  -- /usr/include/gsl/gsl_matrix_double.h:126
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_subcolumn";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_view_array";
   ...
   function gsl_matrix_view_vector
     (v  : access gsl_gsl_vector_double_h.gsl_vector; n1 : stddef_h.size_t;
      n2 : stddef_h.size_t)
   ...
   function gsl_matrix_const_submatrix
     (m : access constant gsl_matrix; i : stddef_h.size_t; j : stddef_h.size_t;
   ...
   function gsl_matrix_const_row
     (m : access constant gsl_matrix; i : stddef_h.size_t)
      return gsl_gsl_vector_double_h
     .u_gsl_vector_const_view  -- /usr/include/gsl/gsl_matrix_double.h:159
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_const_row";

   function gsl_matrix_const_column
     (m : access constant gsl_matrix; j : stddef_h.size_t)
      return gsl_gsl_vector_double_h
   ...
   function gsl_matrix_const_diagonal
   ...
   function gsl_matrix_const_subdiagonal
     (m : access constant gsl_matrix; k : stddef_h.size_t)
      return gsl_gsl_vector_double_h
   ...
   function gsl_matrix_const_superdiagonal
     (m : access constant gsl_matrix; k : stddef_h.size_t)
      return gsl_gsl_vector_double_h
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_swap";

   function gsl_matrix_tricpy
     (Uplo : gsl_gsl_blas_types_h.CBLAS_UPLO_t;
      Diag : gsl_gsl_blas_types_h.CBLAS_DIAG_t; dest : access gsl_matrix;
      src  : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:220
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_tricpy";

   function gsl_matrix_swap_rows
     (m : access gsl_matrix; i : stddef_h.size_t; j : stddef_h.size_t)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:222
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_swap_rows";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_transpose";

   function gsl_matrix_transpose_memcpy
     (dest : access gsl_matrix; src : access constant gsl_matrix)
   ...
   function gsl_matrix_max
     (m : access constant gsl_matrix)
      return double  -- /usr/include/gsl/gsl_matrix_double.h:229
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_max";

   function gsl_matrix_min
     (m : access constant gsl_matrix)
      return double  -- /usr/include/gsl/gsl_matrix_double.h:230
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_min";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_minmax";

   procedure gsl_matrix_max_index
     (m    : access constant gsl_matrix; imax : access stddef_h.size_t;
      jmax : access stddef_h
        .size_t)  -- /usr/include/gsl/gsl_matrix_double.h:233
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_max_index";

   procedure gsl_matrix_min_index
     (m    : access constant gsl_matrix; imin : access stddef_h.size_t;
      jmin : access stddef_h
        .size_t)  -- /usr/include/gsl/gsl_matrix_double.h:234
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_min_index";

   procedure gsl_matrix_minmax_index
     (m    : access constant gsl_matrix; imin : access stddef_h.size_t;
      jmin : access stddef_h.size_t; imax : access stddef_h.size_t;
      jmax : access stddef_h
        .size_t)  -- /usr/include/gsl/gsl_matrix_double.h:235
   with
     Import        => True, Convention => C,
     External_Name => "gsl_matrix_minmax_index";

   function gsl_matrix_equal
     (a : access constant gsl_matrix; b : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:237
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_equal";

   function gsl_matrix_isnull
     (m : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:239
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_isnull";

   function gsl_matrix_ispos
     (m : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:240
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_ispos";

   function gsl_matrix_isneg
     (m : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:241
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_isneg";

   function gsl_matrix_isnonneg
     (m : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:242
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_isnonneg";

   function gsl_matrix_norm1
     (m : access constant gsl_matrix)
      return double  -- /usr/include/gsl/gsl_matrix_double.h:244
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_norm1";

   function gsl_matrix_add
     (a : access gsl_matrix;
      b : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:246
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_add";

   function gsl_matrix_sub
     (a : access gsl_matrix;
      b : access constant gsl_matrix)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:247
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_sub";

   function gsl_matrix_mul_elements
     (a : access gsl_matrix;
      b : access constant gsl_matrix)
   ...
   function gsl_matrix_div_elements
     (a : access gsl_matrix;
      b : access constant gsl_matrix)
   ...
   function gsl_matrix_scale
     (a : access gsl_matrix;
      x : double)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:250
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_scale";

   function gsl_matrix_scale_rows
     (a : access gsl_matrix;
      x : access constant gsl_gsl_vector_double_h.gsl_vector)
      return int  -- /usr/include/gsl/gsl_matrix_double.h:251
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_scale_rows";

   function gsl_matrix_scale_columns
     (a : access gsl_matrix;
      x : access constant gsl_gsl_vector_double_h.gsl_vector)
   ...
   function gsl_matrix_add_constant
     (a : access gsl_matrix;
      x : double)
   ...
   function gsl_matrix_add_diagonal
     (a : access gsl_matrix;
      x : double)
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_get_row";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_get_col";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_set_row";
   ...
   with
     Import => True, Convention => C, External_Name => "gsl_matrix_set_col";
