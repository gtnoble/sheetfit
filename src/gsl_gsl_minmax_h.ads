...
package gsl_gsl_minmax_h is
   ...
   function gsl_max
     (a : double;
      b : double)
      return double  -- /usr/include/gsl/gsl_minmax.h:43
   with
     Import => True, Convention => C, External_Name => "gsl_max";

   function gsl_min
     (a : double;
      b : double)
      return double  -- /usr/include/gsl/gsl_minmax.h:44
   with
     Import => True, Convention => C, External_Name => "gsl_min";
