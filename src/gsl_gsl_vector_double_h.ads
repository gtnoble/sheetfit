...
package gsl_gsl_vector_double_h is
  ...
  --  
   ...
   type gsl_vector is record
      size : aliased stddef_h.size_t;  -- /usr/include/gsl/gsl_vector_double.h:44
      stride : aliased stddef_h.size_t;  -- /usr/include/gsl/gsl_vector_double.h:45
      data : access double;  -- /usr/include/gsl/gsl_vector_double.h:46
      block : access gsl_gsl_block_double_h.gsl_block_struct;  -- /usr/include/gsl/gsl_vector_double.h:47
  ...
  -- Allocation  
   function gsl_vector_alloc (n : stddef_h.size_t) return access gsl_vector  -- /usr/include/gsl/gsl_vector_double.h:69
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_alloc";

   function gsl_vector_calloc (n : stddef_h.size_t) return access gsl_vector  -- /usr/include/gsl/gsl_vector_double.h:70
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_alloc_from_block
     (b : access gsl_gsl_block_double_h.gsl_block_struct;
      ...
      n : stddef_h.size_t;
      stride : stddef_h.size_t) return access gsl_vector  -- /usr/include/gsl/gsl_vector_double.h:72
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_alloc_from_vector
     (v : access gsl_vector;
      offset : stddef_h.size_t;
      n : stddef_h.size_t;
      stride : stddef_h.size_t) return access gsl_vector  -- /usr/include/gsl/gsl_vector_double.h:77
   with Import => True, 
        Convention => C, 
  ...
  -- Views  
   function gsl_vector_view_array (v : access double; n : stddef_h.size_t) return u_gsl_vector_view  -- /usr/include/gsl/gsl_vector_double.h:87
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_view_array_with_stride
     (base : access double;
      ...
      n : stddef_h.size_t) return u_gsl_vector_view  -- /usr/include/gsl/gsl_vector_double.h:90
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_view_array_with_stride";

   function gsl_vector_const_view_array (v : access double; n : stddef_h.size_t) return u_gsl_vector_const_view  -- /usr/include/gsl/gsl_vector_double.h:95
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_const_view_array_with_stride
     (base : access double;
      stride : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_const_view  -- /usr/include/gsl/gsl_vector_double.h:98
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_subvector
     (v : access gsl_vector;
      i : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_view  -- /usr/include/gsl/gsl_vector_double.h:103
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_subvector_with_stride
     (v : access gsl_vector;
      i : stddef_h.size_t;
      stride : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_view  -- /usr/include/gsl/gsl_vector_double.h:108
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_const_subvector
     (v : access constant gsl_vector;
      i : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_const_view  -- /usr/include/gsl/gsl_vector_double.h:114
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_const_subvector_with_stride
     (v : access constant gsl_vector;
      i : stddef_h.size_t;
      stride : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_const_view  -- /usr/include/gsl/gsl_vector_double.h:119
   with Import => True, 
        Convention => C, 
  ...
  -- Operations  
   ...
   function gsl_vector_set_basis (v : access gsl_vector; i : stddef_h.size_t) return int  -- /usr/include/gsl/gsl_vector_double.h:128
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_swap_elements
     (v : access gsl_vector;
      i : stddef_h.size_t;
      j : stddef_h.size_t) return int  -- /usr/include/gsl/gsl_vector_double.h:141
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_max_index (v : access constant gsl_vector) return stddef_h.size_t  -- /usr/include/gsl/gsl_vector_double.h:147
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_max_index";

   function gsl_vector_min_index (v : access constant gsl_vector) return stddef_h.size_t  -- /usr/include/gsl/gsl_vector_double.h:148
   with Import => True, 
        Convention => C, 
   ...
   procedure gsl_vector_minmax_index
     (v : access constant gsl_vector;
      ...
      imax : access stddef_h.size_t)  -- /usr/include/gsl/gsl_vector_double.h:149
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_get (v : access constant gsl_vector; i : stddef_h.size_t) return double  -- /usr/include/gsl/gsl_vector_double.h:168
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_ptr (v : access gsl_vector; i : stddef_h.size_t) return access double  -- /usr/include/gsl/gsl_vector_double.h:170
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_ptr";

   function gsl_vector_const_ptr (v : access constant gsl_vector; i : stddef_h.size_t) return access double  -- /usr/include/gsl/gsl_vector_double.h:171
   with Import => True, 
        Convention => C, 
