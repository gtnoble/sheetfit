...
package gsl_gsl_vector_long_h is
  ...
  --  
   ...
   type gsl_vector_long is record
      ...
      stride : aliased stddef_h.size_t;  -- /usr/include/gsl/gsl_vector_long.h:45
      data : access long;  -- /usr/include/gsl/gsl_vector_long.h:46
      block : access gsl_gsl_block_long_h.gsl_block_long_struct;  -- /usr/include/gsl/gsl_vector_long.h:47
  ...
  -- Allocation  
   function gsl_vector_long_alloc (n : stddef_h.size_t) return access gsl_vector_long  -- /usr/include/gsl/gsl_vector_long.h:69
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_alloc";

   function gsl_vector_long_calloc (n : stddef_h.size_t) return access gsl_vector_long  -- /usr/include/gsl/gsl_vector_long.h:70
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_alloc_from_block
     (b : access gsl_gsl_block_long_h.gsl_block_long_struct;
      ...
      n : stddef_h.size_t;
      stride : stddef_h.size_t) return access gsl_vector_long  -- /usr/include/gsl/gsl_vector_long.h:72
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_alloc_from_vector
     (v : access gsl_vector_long;
      offset : stddef_h.size_t;
      n : stddef_h.size_t;
      stride : stddef_h.size_t) return access gsl_vector_long  -- /usr/include/gsl/gsl_vector_long.h:77
   with Import => True, 
        Convention => C, 
  ...
  -- Views  
   function gsl_vector_long_view_array (v : access long; n : stddef_h.size_t) return u_gsl_vector_long_view  -- /usr/include/gsl/gsl_vector_long.h:87
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_view_array_with_stride
     (base : access long;
      ...
      n : stddef_h.size_t) return u_gsl_vector_long_view  -- /usr/include/gsl/gsl_vector_long.h:90
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_view_array_with_stride";

   function gsl_vector_long_const_view_array (v : access long; n : stddef_h.size_t) return u_gsl_vector_long_const_view  -- /usr/include/gsl/gsl_vector_long.h:95
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_const_view_array_with_stride
     (base : access long;
      stride : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_long_const_view  -- /usr/include/gsl/gsl_vector_long.h:98
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_subvector
     (v : access gsl_vector_long;
      i : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_long_view  -- /usr/include/gsl/gsl_vector_long.h:103
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_subvector_with_stride
     (v : access gsl_vector_long;
      i : stddef_h.size_t;
      stride : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_long_view  -- /usr/include/gsl/gsl_vector_long.h:108
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_const_subvector
     (v : access constant gsl_vector_long;
      i : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_long_const_view  -- /usr/include/gsl/gsl_vector_long.h:114
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_const_subvector_with_stride
     (v : access constant gsl_vector_long;
      i : stddef_h.size_t;
      stride : stddef_h.size_t;
      n : stddef_h.size_t) return u_gsl_vector_long_const_view  -- /usr/include/gsl/gsl_vector_long.h:119
   with Import => True, 
        Convention => C, 
  ...
  -- Operations  
   ...
   function gsl_vector_long_set_basis (v : access gsl_vector_long; i : stddef_h.size_t) return int  -- /usr/include/gsl/gsl_vector_long.h:128
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_swap_elements
     (v : access gsl_vector_long;
      i : stddef_h.size_t;
      j : stddef_h.size_t) return int  -- /usr/include/gsl/gsl_vector_long.h:141
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_max_index (v : access constant gsl_vector_long) return stddef_h.size_t  -- /usr/include/gsl/gsl_vector_long.h:147
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_max_index";

   function gsl_vector_long_min_index (v : access constant gsl_vector_long) return stddef_h.size_t  -- /usr/include/gsl/gsl_vector_long.h:148
   with Import => True, 
        Convention => C, 
   ...
   procedure gsl_vector_long_minmax_index
     (v : access constant gsl_vector_long;
      ...
      imax : access stddef_h.size_t)  -- /usr/include/gsl/gsl_vector_long.h:149
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_scale (a : access gsl_vector_long; x : long) return int  -- /usr/include/gsl/gsl_vector_long.h:155
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_scale";

   function gsl_vector_long_add_constant (a : access gsl_vector_long; x : long) return int  -- /usr/include/gsl/gsl_vector_long.h:156
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_axpby
     (alpha : long;
      x : access constant gsl_vector_long;
      beta : long;
      y : access gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:157
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_axpby";

   function gsl_vector_long_sum (a : access constant gsl_vector_long) return long  -- /usr/include/gsl/gsl_vector_long.h:158
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_sum";

   function gsl_vector_long_equal (u : access constant gsl_vector_long; v : access constant gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:160
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_equal";

   function gsl_vector_long_isnull (v : access constant gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:163
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_isnull";

   function gsl_vector_long_ispos (v : access constant gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:164
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_ispos";

   function gsl_vector_long_isneg (v : access constant gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:165
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_isneg";

   function gsl_vector_long_isnonneg (v : access constant gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:166
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_isnonneg";

   function gsl_vector_long_get (v : access constant gsl_vector_long; i : stddef_h.size_t) return long  -- /usr/include/gsl/gsl_vector_long.h:168
   with Import => True, 
        Convention => C, 
   ...
   function gsl_vector_long_ptr (v : access gsl_vector_long; i : stddef_h.size_t) return access long  -- /usr/include/gsl/gsl_vector_long.h:170
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_ptr";

   function gsl_vector_long_const_ptr (v : access constant gsl_vector_long; i : stddef_h.size_t) return access long  -- /usr/include/gsl/gsl_vector_long.h:171
   with Import => True, 
        Convention => C, 
